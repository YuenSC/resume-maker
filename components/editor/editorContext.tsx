...
const defaultResume: EditorResume = {
  ...
  aboutMe: {
    title: "",
    value:
      "Frontend Developer with 2 years of experience in building web and mobile app using React, React Native, and Typescript. A team player with a strong ability to collaborate with cross-functional teams and effectively communicate technical concepts.",
  },
  personalDetails: {
    title: "",
    location: "Hong Kong",
